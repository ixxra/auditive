/* debug.c generated by valac 0.20.1, the Vala compiler
...
static void dbg_real_key_press (screen* base, gint key_num) {
	...
	self = (dbg*) base;
	_tmp0_ = key_num;
	SCREEN_CLASS (dbg_parent_class)->key_press (G_TYPE_CHECK_INSTANCE_CAST (self, TYPE_SCREEN, screen), _tmp0_);
...
static void dbg_finalize (screen* obj) {
	dbg * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, TYPE_DBG, dbg);
